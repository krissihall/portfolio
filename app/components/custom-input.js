 ...
 * Has custom functionality to manipulate label/placeholder as user interacts with field
 *
 * Styled using styles/components/custom-input.styl.
 *
 * Parameters:
 * Required - label
...
export default Ember.Component.extend({
  ...
  classNames: ['form-group', 'custom-input'],
