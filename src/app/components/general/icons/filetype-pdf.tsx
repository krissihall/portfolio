...
export default function FiletypePdf({ color, hoverColor, hasHover, height, width, className }: Props) {
    ...
    if (!hoverColor && isEmpty(hoverColor)) {
        hoverColor = "#ff2577";
    }
    ...
    return (
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={hasHover && hover ? hoverColor : color} className={clsx("bi bi-filetype-pdf", {className})} viewBox="0 0 16 16">
