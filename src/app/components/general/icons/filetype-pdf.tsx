...
export default function FiletypePdf({ color, height, width, className }: Props) {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={color} className={clsx("bi bi-filetype-pdf", {className})} viewBox="0 0 16 16">
